...
import img from "./assets/images/zang.jpg";
...
const initiatives = [
  ...
  },
  {
    ...
    description:
      "An innovative solution designed for individuals with disabilities, particularly amputees, to interact with computers using foot movements, enhancing independence and accessibility.",
    content: `The Computer Foot Mouse is an innovative device designed to improve the lives of individuals with disabilities, especially amputees. This technology allows users to interact with computers using foot movements, providing them with greater independence and access to digital tools for education, employment, and social interaction. This solution is aimed at creating a more inclusive and equitable society by ensuring that individuals of all abilities can engage with the digital world. By providing adaptive tools, we break down barriers and promote independence.`,
